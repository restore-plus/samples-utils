...
# Samples
samples_file <- "data/raw/samples/S_PastHerbacea_2010_v3_ok.gpkg"

# Samples directory
base_samples_dir <- "data/derived/samples/pastagem-herbacea/"
...
for (target_year in target_years) {
  ...
  # Save results
  saveRDS(samples_ts, samples_dir / paste0("samples-pastagem-herbacea-", eco_name, "-", target_year, ".rds"))
}
